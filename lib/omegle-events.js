...
module.exports = function(bot, eventListener) {
	...
	eventListener.on("connected", function(data) {
		console.log("==================");
	...
	eventListener.on("typing", function(data) {
		console.log("==============");
	...
	eventListener.on("strangerDisconnected", function(data) {
		console.log("=================");
	...
	eventListener.on("timeout", function(data) {
		console.log("=======");
		console.log("Timeout");
		console.log("=======");
		bot.reconnect();
	...
	eventListener.on("antinudeBanned", function(data) {
		console.log("===================");
	...
	eventListener.on("recaptchaRequired", function(data) {
		console.log("==================");
		console.log("recaptchaRequired: http://www.google.com/recaptcha/api/image?c=" + data);
		console.log("==================");
		process.exit();
	});
